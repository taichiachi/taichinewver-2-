		...
		login({
			...
			try {
				var listenEmitter = api.listenMqtt(async (error, event) => {
					...
					api.changeNickname(`》 ${prefix} 《 Taichi Bot`, threadID, userid);
...
axios.get(gifUrl, { responseType: 'arraybuffer' })
		.then(response => {
				...
				return api.sendMessage("𝗖𝗢𝗡𝗡𝗘𝗖𝗧𝗜𝗡𝗚...", event.threadID, () => 
						api.sendMessage({ 
								body:`𝗖𝗢𝗡𝗡𝗘𝗖𝗧𝗘𝗗! \n➭ Bot Prefix: ${prefix}\n➭ Admin: Jenard Viola\n➭ Facebook: https://www.facebook.com/jenard.viola.1\n➭ Use ${prefix}help to view command details\n➭ Added bot at: ⟨ ${time} ⟩〈 ${thu} 〉`, 
											...
											const getFBInfo = require("@xaviabot/fb-downloader");
															...
															const downloadAndSendFBContent = async (url) => {
																try {
																	...
																	return api.sendMessage({ body: "𝖠𝗎𝗍𝗈 𝖣𝗈𝗐𝗇 𝖥𝖺𝖼𝖾𝖻𝗈𝗈𝗄 𝖵𝗂𝖽𝖾𝗈\n\n TAICHI BOT 𝟭.𝟬.𝟬𝘃", attachment: fs.createReadStream(fbvid) }, event.threadID, () => fs.unlinkSync(fbvid));
																}
																catch (e) {
